          ...
          <div className="container">
            <div className="row" id="">
              <div className="title-area text-center">
                ...
                <p>
                  {" "}
                  From web applications to digital marketing, brand promotion,
                  and eCommerce solutions, I provide everything you need to
              ...
              <div className="col-md-4 fadeInRight">
                ...
                >
                  <div className="service-dataa">
                    ...
                    <p>
                      I create cutting-edge, user-friendly web apps that are
                      responsive and tailored to your company's requirements,
                      providing a smooth functioning experience.
                    </p>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="col-md-4 fadeInRight">
                ...
                >
                  <div className="service-dataa">
                    ...
                    <p>
                      From SEO to social media, I offer comprehensive digital
                      marketing services that increase visibility and grow your
                      business.
                    </p>
                  </div>
                </motion.div>
              ...
              <div className="col-md-4 fadeInRight">
                ...
                >
                  <div className="service-dataa">
                    ...
                    <p>
                      I help elevate your brand by creating impactful promotion
                      strategies that resonate with your audience and build
                      lasting recognition.
                    </p>
                  </div>
                </motion.div>
              ...
              <div className="col-md-4 fadeInRight">
                ...
                >
                  <div className="service-dataa">
                    ...
                    <p>
                      I provide customized eCommerce solutions that streamline
                      your online sales process, enhance user experience, and
              ...
              <div className="col-md-4 fadeInRight">
                ...
                >
                  <div className="service-dataa">
                    ...
                    <p>
                      I offer comprehensive website maintenance services to
                      ensure your site runs smoothly, stays secure, and performs
                      optimally. From regular updates to troubleshooting.
                    </p>
                  </div>
                </motion.div>
              </div>
